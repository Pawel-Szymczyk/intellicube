...
public class ControlPanel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch switchStatus = (Switch) findViewById(R.id.switchStatus);
        switchStatus.setOnCheckedChangeListener(switchClick);
    ...
    CompoundButton.OnCheckedChangeListener switchClick = new CompoundButton.OnCheckedChangeListener() {
        @Override
